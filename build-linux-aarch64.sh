...
chmod 644 build/libs/Darkan.jar

cp native/build-aarch64/src/Darkan build/linux-aarch64/
cp build/libs/Darkan.jar build/linux-aarch64/
...
# Symlink AppRun -> Darkan
ln -s Darkan AppRun

# Ensure Darkan is executable to all users
chmod 755 Darkan
popd
