...
cp native/build-x86/src/Release/Darkan.exe build/win-x86/
cp build/libs/Darkan.jar build/win-x86/
...
echo Darkan.exe 32bit sha256sum
sha256sum build/win-x86/Darkan.exe

dumpbin //HEADERS build/win-x86/Darkan.exe
