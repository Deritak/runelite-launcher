...
cp native/build-x64/src/Release/Darkan.exe build/win-x64/
cp build/libs/Darkan.jar build/win-x64/
...
echo Darkan.exe 64bit sha256sum
sha256sum build/win-x64/Darkan.exe

dumpbin //HEADERS build/win-x64/Darkan.exe
