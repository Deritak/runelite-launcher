...
sha256sum build/libs/Darkan.jar
...
cp native/build-aarch64/src/Release/Darkan.exe build/win-aarch64/
cp build/libs/Darkan.jar build/win-aarch64/
...
echo Darkan.exe aarch64 sha256sum
sha256sum build/win-aarch64/Darkan.exe

dumpbin //HEADERS build/win-aarch64/Darkan.exe
